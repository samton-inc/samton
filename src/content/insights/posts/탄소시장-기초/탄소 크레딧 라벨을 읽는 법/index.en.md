...
type: CARBON LABEL
title: How to Read Carbon-Credit Labels
summary: A practical guide to what labels such as CCP, CORSIA, Article 6 authorization, CCB and SDG+ confirm—and what they do not guarantee.
date: 2026.07.15
featured: false
published: true
---
...
![Reviewing carbon-credit registry records against supporting documents](images/carbon-credit-label-review.jpg)
...
A VCU issued under Verra's VCS, for example, may receive CCB, SD VISta or CCP labels. The VCU is the underlying unit; each label adds separate information. Verra notes that multiple labels may be attached to one VCU. [Verra: VCU Labels](https://verra.org/programs/verified-carbon-standard/verified-carbon-units-labels/)
...
1. The crediting program passes assessments of governance, transparency, registry systems and verification and becomes **CCP-Eligible**.
2. A specific category and methodology within that program passes assessments of additionality, quantification and permanence and becomes **CCP-Approved**.

Only eligible credits issued under categories and methodologies that pass both stages can carry the label. “Verra is CCP-Eligible” is not the same as “this VCU has a CCP label.” The actual methodology and conditions must be checked. [ICVCM Core Carbon Principles](https://icvcm.org/core-carbon-principles/?redirect=true) · [ICVCM assessment process](https://icvcm.org/how-we-assess-carbon-crediting-programs/)
...
Some registries show the stages separately. Verra can apply **Article 6 Authorized** after reviewing an LOA and add **Article 6 Correspondingly Adjusted** after the adjustment is confirmed in the BTR. “Authorized” alone should not be read as proof that the adjustment is complete. [Verra Article 6 labels](https://verra.org/verra-stakeholder-update-webinar-april-2026-recap/)

In the Article 6.4 registry, an A6.4ER authorized for international use becomes an **AER (Authorized Emission Reduction)**; a non-authorized unit is categorized as an **MCU (Mitigation Contribution Unit)** contributing to the host country's NDC. [UNFCCC Article 6.4 registry](https://unfccc.int/process-and-meetings/the-paris-agreement/article-6/article-64-pacm/registry)
...
Verra's **CCB** label shows whether a forest or land project creates net benefits for climate, communities and biodiversity. **SD VISta** indicates that independently verified social and environmental benefits occurred during the VCU monitoring period. [Verra CCB](https://verra.org/programs/ccbs/ccbs-program-details/) · [Verra SD VISta](https://verra.org/programs/sd-verified-impact-standard/)

Gold Standard displays certified SDG impacts in its registry, connecting mitigation with sustainable-development contributions. [Gold Standard Impact Registry](https://www.goldstandard.org/impact-registry)
...
GCC issues the underlying mitigation outcome as an ACC; labels are added when selected extra criteria are met. ACC and SDG+ are not synonymous. [GCC project standards and labels](https://globalcarboncouncil.com/about/who-we-are/) · [GCC program FAQ](https://globalcarboncouncil.com/for-stakeholders/frequently-asked-questions/)
...
1. **Underlying unit:** Which program issued the VCU, ACC, VER or other unit?
2. **Project and methodology:** Which activity used which calculation rules?
3. **Vintage:** When did the labelled mitigation occur?
4. **Scope of the label:** Does it concern integrity, market eligibility, national authorization or co-benefits?
5. **Verification evidence:** Are independent verification reports and host-country documents available?
6. **Use and retirement:** Is the unit appropriate for the intended claim, and will it be retired after use?
