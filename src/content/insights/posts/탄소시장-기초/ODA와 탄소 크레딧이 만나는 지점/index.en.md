...
The World Bank explains that the MRV systems used to confirm results-based climate-finance outcomes are also used to demonstrate reductions in carbon markets. Once promised results are verified, grants or performance payments can be released, and the same data foundation may support credit issuance. [World Bank: Results-Based Climate Finance](https://www.worldbank.org/en/news/feature/2022/08/17/what-you-need-to-know-about-results-based-climate-finance)

Multilateral development banks also note that the amount financed does not by itself reveal actual performance; common systems are needed to measure mitigation and adaptation results. [World Bank: Common Approach to Measuring Climate Results](https://www.worldbank.org/en/topic/climatechange/publication/common-approach-to-measuring-climate-results)
...
The World Bank designed the carbon revenue to flow back into a fund supporting further clean-cooking deployment: grants launch the work, and verified mitigation finances the next round. [World Bank clean-cooking case study](https://www.worldbank.org/en/results/2023/01/19/moving-the-needle-on-clean-cooking-for-all)
...
The World Bank plans USD 5 billion in finance and aims to mobilize an additional USD 10 billion from public and private sources. [World Bank ASCENT overview](https://thedocs.worldbank.org/en/doc/1233e4fb6c0f39e839979743c988fcf0-0010012024/accelerating-sustainable-and-clean-energy-access-transformation-ascent-in-eastern-southern-africa)
...
GCC also implements and operates a digital portal connecting project registration, data review, verification reports and credit issuance. [GCC ASCENT Carbon Program](https://globalcarboncouncil.com/how-gcc-works/energy-access-program/)
