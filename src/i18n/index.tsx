...
const english: Record<string, string> = {
  ...
  "신뢰로 함께하는 고객과 파트너": "Trusted by clients and partners",
  ...
  "데이터 자산화": "we help turn data into an asset",
  "를 지원합니다.": ".",
  ...
  "고객에게는 하나의 완성된 맞춤형 시스템을 제공합니다. 그 내부에는 현장과 프로젝트에서 검증된 기술 엔진이 작동해 새로운 데이터와 규제, 업무 기능을 유연하게 확장할 수 있습니다.": "We deliver a unified system tailored to each client. Under the hood, technology engines proven in real-world projects make it easy to support new data sources, regulatory requirements and workflows.",
  ...
  "엔진은 별개의 제품이 아닙니다. 고객의 데이터와 업무에 맞춘 하나의 시스템 안에서 필요한 역할을 수행하며, 확장성과 데이터 공신력을 함께 만듭니다.": "These engines are not standalone products. Each plays a specific role within a system tailored to the client’s data and operations, delivering both flexibility and trustworthy data.",
  "자세히 보기": "Learn more",
  "지원 범위": "Capabilities",
  ...
  "필요한 엔진을 선택해 조립해 보세요.": "Choose the engines you need and see how they work together.",
  "엔진을 선택하면 아래 조립 캔버스에 바로 반영됩니다.": "Your selections appear instantly in the system configuration below.",
  "조립 가능한 소프트웨어 엔진": "Available software engines",
  "방법론·탄소 산정 엔진에 적용할 산정 기준과 세부 방법론": "Calculation standards and methodologies for the carbon accounting engine",
  ...
  "샘튼의 기술과 현장을": "See Samton’s technology",
  "더 깊이 살펴보세요.": "in action.",
  ...
  "바로가기": "Explore",
  "우리 회사에 필요한": "Design the DMRV system",
  ...
  "샘튼 소식": "Samton News",
  "협약, 프로젝트, 출장과 행사, 새로운 시스템 업데이트를 전합니다.": "Partnerships, projects, field updates, events and product news from Samton.",
  ...
  "협약, 프로젝트, 출장과 행사, 시스템 업데이트 등 샘튼의 새로운 활동을 전합니다.": "Updates on Samton’s partnerships, projects, fieldwork, events and systems.",
...
const japanese: Record<string, string> = {
  ...
  "크레딧 발급까지, End-to-End": "クレジット発行までを、\nEnd-to-Endで",
  "탄소 데이터 시스템을 구축합니다.": "支える炭素データシステムを\n構築します。",
  ...
  "신뢰로 함께하는 고객과 파트너": "ともに信頼を築くお客様・パートナー",
  "글로벌 완성차 기업부터 모빌리티·환경·공공기관까지, 다양한 산업의 데이터 과제를 함께 해결해 왔습니다.": "グローバル自動車メーカーからモビリティ、環境、公共機関まで、多様な産業のデータ課題を共に解決してきました。",
  "소프트웨어를 넘어,": "ソフトウェアの先へ、",
  "데이터 자산화": "データを価値ある資産へ",
  "를 지원합니다.": "変える仕組みをつくります。",
  "주식회사 샘튼은 환경·탄소·모빌리티 데이터의 수집부터 검증, 산정과 보고까지 연결하는 B2B 데이터 기술기업입니다.": "Samtonは、環境・炭素・モビリティデータの収集から検証、算定、報告までをつなぐB2Bデータテクノロジー企業です。",
  "고객에게는 하나의 완성된 맞춤형 시스템을 제공합니다. 그 내부에는 현장과 프로젝트에서 검증된 기술 엔진이 작동해 새로운 데이터와 규제, 업무 기능을 유연하게 확장할 수 있습니다.": "お客様ごとに最適化した一つの統合システムを提供します。その中では、現場とプロジェクトで実績を重ねた技術エンジンが連携し、新たなデータ、規制要件、業務機能にも柔軟に対応します。",
  ...
  "구성하는 ": "構成する",
  "검증된 소프트웨어 엔진": "実績に裏付けられた\u200Bソフトウェアエンジン",
  "엔진은 별개의 제품이 아닙니다. 고객의 데이터와 업무에 맞춘 하나의 시스템 안에서 필요한 역할을 수행하며, 확장성과 데이터 공신력을 함께 만듭니다.": "エンジンは個別に販売する製品ではありません。お客様のデータと業務に合わせた一つのシステムの中で役割を分担し、拡張性とデータの信頼性を両立させます。",
  "자세히 보기": "詳しく見る",
  "지원 범위": "対応範囲",
  ...
  "필요한 엔진을 선택해 조립해 보세요.": "必要なエンジンを選び、組み合わせをお試しください。",
  "엔진을 선택하면 아래 조립 캔버스에 바로 반영됩니다.": "選択したエンジンは、下のシステム構成にすぐ反映されます。",
  "조립 가능한 소프트웨어 엔진": "組み立て可能なソフトウェアエンジン",
  "방법론·탄소 산정 엔진에 적용할 산정 기준과 세부 방법론": "炭素算定エンジンに適用する算定基準と方法論",
  ...
  "샘튼 소식": "Samtonニュース",
  "협약, 프로젝트, 출장과 행사, 새로운 시스템 업데이트를 전합니다.": "連携、プロジェクト、現地活動、イベント、システム更新など、Samtonの最新情報をお届けします。",
  ...
  "협약, 프로젝트, 출장과 행사, 시스템 업데이트 등 샘튼의 새로운 활동을 전합니다.": "連携、プロジェクト、現地活動、イベント、システム更新など、Samtonの最新情報をお届けします。",
